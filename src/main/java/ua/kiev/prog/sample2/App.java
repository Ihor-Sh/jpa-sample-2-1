...
public class App {
    public static void main( String[] args ) {
        ...
        try {
            Group group1 = new Group("Course-1 JavaSE");
            Group group2 = new Group("Course-2 JavaEE");
            Client client;
            long gid1, gid2;
...
/*          // Home Work begin
            ...
            Вывести на экран список групп с указанием
            количества студентов в каждой группе.*/
